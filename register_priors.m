...
% ***************************************************************************************************
    ...
    reg_resample_aff_struct =  ['reg_resample ',...
    ...
    reg_resample_aff_csf =  ['reg_resample ',...
                    '-ref ', [reference,'.nii.gz'], ' ', ...
    ...
    reg_resample_aff_gm =  ['reg_resample ',...
                    '-ref ', [reference,'.nii.gz'], ' ', ...
    ...
    reg_resample_aff_wm =  ['reg_resample ',...
                     '-ref ', [reference,'.nii.gz'], ' ', ...
